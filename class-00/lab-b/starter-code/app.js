...
//"this" is a reference to the object Student. In this case it outputs Name, age, and hometown
// 2. What is "this" when joe.scopeArrow() is invoked?
//In this case "this" is a reference to Window object 
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions don't have their own 'this." As a result, when "this" is called within an arrow function, it looks for its enclosing scope. In this case it's Window
