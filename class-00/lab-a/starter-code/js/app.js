...
function displayPics(){
  ...
  // We are trying to access a variable (rando), which is declared with 'const' inside a function displayPics, from outside of the function. Rando will have the scope only inside the function. So to see it, console log needs to be moved inside the function.
  console.log(viewed);
